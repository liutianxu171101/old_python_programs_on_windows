...
def writecitycsv(city):
    
    global f = open('E://Python/mydatas/weathers/'+city + '.csv','w',encoding='UTF-8',newline='')
    global csv_writer = csv.writer(f)
    global csv_writer.writerow(["日期","白天天气","夜晚天气","最高气温","最低气温"])
